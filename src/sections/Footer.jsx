  ...
  return (
    <footer className=" w-full pb-8 relative z-10 " data-aos="fade-up">
      ...
      <div className="container-wrapper mt-8 ">
        ...
        Legal Disclaimer: PinkSol is a meme coin for fun, with no real value or profit expectation. By buying PinkSol, you agree you've read and understood this. its Inspired by Hardwork done by Pinksale and their team. and we appricaite tere hardwork they do for Crypto.
        </p>
        <div className="">
