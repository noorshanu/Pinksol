  ...
  return (
    <div className=" container-wrapper  px-4 relative  " data-aos="fade-right">
         ...
         <div className=' flex justify-between items-center gap-4 flex-col sm:flex-row'>
            ...
            <div  className=" border-[#bc1d5c]  bg-[#fd8b0000] border-2   py-8 px-4 rounded-2xl shadow-xl w-full sm:w-[250px]">
            ...
            <div  className=" border-[#bc1d5c]  bg-[#fd8b0000] border-2   py-8 px-4 rounded-2xl shadow-xl w-full sm:w-[280px]">
            <h1 className=' text-2xl font-semibold  pb-2'>
                3. Go to Raydium
                </h1>
                <p>
